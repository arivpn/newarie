...
const vcard = 'BEGIN:VCARD\n' 
            ...
            + 'FN:Arietube\n'  
            + 'ORG: Arie Botz;\n' 
            + 'TEL;type=CELL;type=VOICE;waid=6288245009287:+6288245009287\n'  //ganti nomor lu
            + 'END:VCARD' 
prefix ='' 
blocked = [] 
replitx = '*ARIE BOTZ*' 
...
const ownerNumber = ["6288245009287@s.whatsapp.net"]   
//###########
...
- *Pesan :* ${body ? body : '-'}\`\`\``
	...
	client.on('message-new', async (mek) => {
		...
		try {
            ...
            //-
            const freply = { key: { fromMe: false, participant: `6288245009287@s.whatsapp.net`, ...(from ? { remoteJid: "6283136505591-1614953337@g.us" } : {}) },"itemCount":100, message: { "imageMessage": { "url": "https://mmg.whatsapp.net/d/f/At0x7ZdIvuicfjlf9oWS6A3AR9XPh0P-hZIVPLsI70nM.enc", "mimetype": "image/png", "caption": `${YahahaHayyuk}`, "fileSha256": "+Ia+Dwib70Y1CWRMAP9QLJKjIJt54fKycOfB2OEZbTU=", "fileLength": "28777", "height": 1080, "width": 1079, "mediaKey": "vXmRR7ZUeDWjXy5iQk17TrowBzuwRya0errAFnXxbGc=", "fileEncSha256": "sR9D2RS5JSifw49HeBADguI23fWDz1aZu4faWG/CyRY=", "directPath": "/v/t62.7118-24/21427642_840952686474581_572788076332761430_n.enc?oh=3f57c1ba2fcab95f2c0bb475d72720ba&oe=602F3D69", "mediaKeyTimestamp": "1610993486", "title": `Subrek Herman Chanel`, "jpegThumbnail": fs.readFileSync('./lib/cuk.jpeg')} } }
			const fkontak = { key: { fromMe: false, participant: `6288245009287@s.whatsapp.net`, ...(from ? { remoteJid: '16504228206@s.whatsapp.net' } : {}) }, message: { "contactMessage": { "displayName": `${YahahaHayyuk}`, "vcard": `BEGIN:VCARD\nVERSION:3.0\nN:XL;${YahahaHayyuk},;;;\nFN:${YahahaHayyuk},\nitem1.TEL;waid=${sender.split('@')[0]}:${sender.split('@')[0]}\nitem1.X-ABLabel:Ponsel\nEND:VCARD`, "jpegThumbnail": fs.readFileSync('./lib/cuk.jpeg')}}}
			const ftoko = { key: { fromMe: false, participant: `6288245009287@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { "productMessage": { "product": { "productImage":{ "mimetype": "image/jpeg", "jpegThumbnail": fs.readFileSync('./lib/cuk.jpeg') }, "title": `Subrek Herman Chanel`, "productImageCount": 9999 }, "businessOwnerJid": `6288245009287@s.whatsapp.net`}}}
...
client.sendMessage(from, wew, image, {quoted: fkontak, caption: zain, pushname, prefix, getLevelingXp, getLevelingLevel, sender, role })
		...
		case 'group':
			...
			case '#sc':
	        case 'SCRIP':
	        client.sendMessage(from, 'Bot Ini Menggunakan Sc :https://m.youtube.com/channel/UC0rPHvwr0sJtaccF8Mm1Xng',MessageType.text, {quoted: freply})
	         break
           case 'setname':
					if (!isGroup) return reply(ind.groupo())
					if (!isGroupAdmins) return reply(ind.admin())
...
║╠ Contoh: 
║╠ #suratto 6288245009287|Hai Juga
║╚▸
╚═══ ◤ *${namabot}* ◢ `
